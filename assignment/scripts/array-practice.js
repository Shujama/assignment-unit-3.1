...
let favoriteFoods= ['pizza', 'shawarma', 'tacos', 'biryani'];
...
console.log('Number of items:', numberOfFoods);
...
console.log('The lastColor is', lastColor);
console.log('The new colors array is:', colors);
...
console.log('New colors array is', colors);
...
gems[1]= 'Tourmaline';
console.log('The gems array', gems);
...
console.log('reversed gems array', gems);
...
//     Don't forget to console.log `gemString`...
  ...
  // .join converts array to string so put and in place of comma . from (',') to (' and ')
